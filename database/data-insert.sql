...
insert into Users(username, pw, uname, email, city, state, country, dob, short_desc, points) values ('goldsmith0', 'goldminerlol3@', 'Aliya Goldsmith', 'golden98@gmail.com', 'Orlando', 'Florida', 'United States', '1998-07-18', 'Computer Science graduate student. Currently looking for a job', 500);
...
insert into Topic (topic_name) value ('Selection Algorithms');
...
insert into Questions(topic_id,user_id,title,q_text,q_time, resolved) values ('7','12','Types of Hashing','What are the different types of hash for hash map?','2022-01-13 9:03:02', 0);
insert into Questions(topic_id,user_id,title,q_text,q_time, resolved) values ('7','19','Probe Sequences','What are probe sequences? And are there more than one type of probe sequences?','2021-03-19 10:21:20', 0);
insert into Questions(topic_id,user_id,title,q_text,q_time, resolved) values ('7','16','Advantage of Hashmap','What are the advantages that hashmap has over linked list?','2022-02-12 15:12:20', 0);
insert into Questions(topic_id,user_id,title,q_text,q_time, resolved) values ('9','17','Sorting Algorithm in Linear time', 'Are there any algorithms that perform sorting in linear time?', '2021-12-17 11:12:22', 0);
insert into Questions(topic_id,user_id,title,q_text,q_time, resolved) values ('9','11','Bucket Sort', 'Does Bucket Sort always sort numbers in linear time?', '2022-01-05 09:05:30', 0);
...
INSERT INTO Answers(user_id,question_id,thumbs_up,thumbs_down,best_answer,a_text,a_time) VALUES ('3','3',0,0,0,'There are values for n where n^200 is greater than 2^n. But asymptomatically as you approach infinity, 2^n grows faster.', '2021-12-27 12:05:12');
INSERT INTO Answers(user_id,question_id,thumbs_up,thumbs_down,best_answer,a_text,a_time) VALUES ('4','4',0,0,0,'Big Oh refers to an upper bound, and big omega refers to a lower bound.', '2021-12-29 07:15:16');
INSERT INTO Answers(user_id,question_id,thumbs_up,thumbs_down,best_answer,a_text,a_time) VALUES ('5','4',0,0,0,'Big-Oh is an upper-bound on the runtime of an algorithm, whereas big-omega is a lower-bound.', '2021-12-31 08:23:27');
INSERT INTO Answers(user_id,question_id,thumbs_up,thumbs_down,best_answer,a_text,a_time) VALUES ('6','5',0,0,0,'An algorithm that returns an element of rank k', '2022-01-13 21:42:09');
INSERT INTO Answers(user_id,question_id,thumbs_up,thumbs_down,best_answer,a_text,a_time) VALUES ('7','5',0,0,0,'A selection algorithm aims to return the kth smallest element from a set of numbers. This element is referred to as the kth Order Statistic.', '2022-01-15 07:47:27');
INSERT INTO Answers(user_id,question_id,thumbs_up,thumbs_down,best_answer,a_text,a_time) VALUES ('8','6',0,0,0,'Select runs in O(n) worst-case, while Randomized-select may be O(n^2)', '2022-01-19 12:02:52');
INSERT INTO Answers(user_id,question_id,thumbs_up,thumbs_down,best_answer,a_text,a_time) VALUES ('9','6',0,0,0,'To add on to an earlier answer by Elon, keep in mind hwo partitioning works in either algorithm.', '2022-01-25 17:37:42');
INSERT INTO Answers(user_id,question_id,thumbs_up,thumbs_down,best_answer,a_text,a_time) VALUES ('10','7',0,0,0,'I think it does not matter', '2022-02-01 14:40:40');
INSERT INTO Answers(user_id,question_id,thumbs_up,thumbs_down,best_answer,a_text,a_time) VALUES ('2','7',0,0,0,'We are not guaranteed a good split when we pick pivots at random.', '2022-02-11 08:40:48');
INSERT INTO Answers(user_id,question_id,thumbs_up,thumbs_down,best_answer,a_text,a_time) VALUES ('3','8',0,0,0,'O(nlogn)', '2022-02-20 15:33:59');
INSERT INTO Answers(user_id,question_id,thumbs_up,thumbs_down,best_answer,a_text,a_time) VALUES ('4','8',0,0,0,'O(n)', '2022-02-21 17:02:06');
INSERT INTO Answers(user_id,question_id,thumbs_up,thumbs_down,best_answer,a_text,a_time) VALUES ('5','9',0,0,0,'It is not actually better, i think.', '2022-02-28 20:24:47');
INSERT INTO Answers(user_id,question_id,thumbs_up,thumbs_down,best_answer,a_text,a_time) VALUES ('6','10',0,0,0,'A binary heap is a data structure that can be visualized as a complete binary tree. You can have min-heaps or max-heaps.', '2022-03-07 04:32:33');
INSERT INTO Answers(user_id,question_id,thumbs_up,thumbs_down,best_answer,a_text,a_time) VALUES ('7','11',0,0,0,'Perhaps', '2022-03-08 18:45:46');
INSERT INTO Answers(user_id,question_id,thumbs_up,thumbs_down,best_answer,a_text,a_time) VALUES ('8','12',0,0,0,'A good split is when the array is split into left and right subarrays each having size less than 3n/4. A bad split is when the array is partitioned in such a way that one of the subarrays has size greater than 3n/4.', '2022-03-11 06:26:00');
...
insert into Answers(user_id,question_id,thumbs_up,thumbs_down,best_answer,a_text,a_time) values ('15','17',0,0,0, 'Probe sequence is a method used in hashing with open addressing. Because in an open addressing hashing we can’t build chains off of the hash table, we use the probe technique to find a location on the table to insert or find an element. There are several types of probe sequence: Linear, Quadratic, Double Hashing, etc.', '2021-03-20 14:25:01');
insert into Answers(user_id,question_id,thumbs_up,thumbs_down,best_answer,a_text,a_time) values ('18','18',0,0,0,'Basic operations on linked list including Search, Insert and Delete take O(n) or linear time to perform. However, when you use Hashmap and implement it carefully, these operations take O(1) or constant time to perform. This is a significant improvement in time complexity.', '2022-02-13 20:00:20');
insert into Answers(user_id,question_id,thumbs_up,thumbs_down,best_answer,a_text,a_time) values ('12','19',0,0,0, 'No there aren’t any algorithms that perform in linear time. Best runtime is Merge Sort / Quick Sort with runtime of O(nlogn)', '2021-12-17 13:20:55');
insert into Answers(user_id,question_id,thumbs_up,thumbs_down,best_answer,a_text,a_time) values ('18','19',0,0,0, 'There do exist algorithms that run linear time however, they run on certain assumptions. An example is Counting Sort. The algorithm runs in linear time however, the input numbers can only be positive integers. The max number must also be reasonable as well because if it is too large, the runtime will increase accordingly.', '2021-12-17 14:22:20');
insert into Answers(user_id,question_id,thumbs_up,thumbs_down,best_answer,a_text,a_time) values ('16','20',0,0,0, 'Not necessarily. It depends on the input numbers you feed to the algorithm and the number of buckets divided up to sort the algorithm. Generally to ensure a linear runtime for bucket sort, the numbers should be uniformly distributed and the number of buckets should be equally divided into ‘n’ number of buckets where n is the number of numbers used in the array.', '2022-01-06 08:02:32');
insert into Answers(user_id,question_id,thumbs_up,thumbs_down,best_answer,a_text,a_time) values ('11','21',0,0,0, 'It can’t be used.', '2022-02-02 12:15:21');
